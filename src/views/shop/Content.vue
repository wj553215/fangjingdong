    ...
    <div class="product">
      <div class="product__item" v-for="item in list" :key="item._id">
        ...
        <div class="product__number">
          ...
          {{ getProdutCartCount(shopId, item._id) }}
...
const useCartEffect = () => {
  ...
  const getProdutCartCount = (shopId, productId) => {
    return cartList?.[shopId]?.productList?.[productId]?.count || 0
  }
  return { cartList, changeCartItem, getProdutCartCount }
}
...
export default {
  ...
  setup () {
    ...
    const { cartList, changeCartItem, getProdutCartCount } = useCartEffect()
    return {
      categories,
      currentTab,
      handleTabClick,
